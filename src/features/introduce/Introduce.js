...
function Introduce() {
  return (
    <>
      ...
      <div className="intro__content">
        <h6>1. Thu thập thông tin cá nhân</h6>
        <p>
      ...
      <div className="intro__content">
        ...
        <p>
          ...
          chỉnh bởi luật pháp Việt Nam và tòa án Việt Nam có thẩm quyền xem xét.
        </p>
      </div>
      <div className="intro__content">
        <h6>3. Quyền lợi khách hàng</h6>
        <p>
          ...
          không mất phí. Bất cứ lúc nào bạn cũng có quyền yêu cầu chúng tôi
